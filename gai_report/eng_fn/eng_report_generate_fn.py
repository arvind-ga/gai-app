...
def generate_pdf_report(
    ...
    # Student Details
    user_name = student_details.get("user_name")
    ...
    student_school = student_details.get("student_school")
    ...
    # Create a PDF
    report_folder= "gai_report/reports"
    os.makedirs(report_folder, exist_ok=True)
    print("student_email:::", student_email)
    pdf_filename = student_details.get("user_name") + ".pdf"
    pdf_report_url = os.path.join(report_folder, pdf_filename)
    doc = SimpleDocTemplate(pdf_report_url, pagesize=A4)
